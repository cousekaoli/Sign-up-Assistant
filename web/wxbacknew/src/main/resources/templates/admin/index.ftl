                ...
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">报名助手后台管理系统</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                        <div class="logo-element">报名助手后台管理系统
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="${ctx!}/admin/activity/index">活动信息管理</a>
                            </li>


                            <li>
                                <a class="J_menuItem" href="${ctx!}/admin/location/index">活动位置信息管理</a>
                            </li>
